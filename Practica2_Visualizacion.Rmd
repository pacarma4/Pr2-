...
ej6graf <- ggplot(ice.river.df,aes(x=time))+ geom_line(aes(y=flow.vat), color="red")+geom_line(aes(y=flow.jok),color="blue")+
  labs(title = "Caudales de dos rios irlandeses en función del tiempo", x ="Tiempo (años)",y ="Caudal")
ej6graf
```
